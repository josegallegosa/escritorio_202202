odoo.define('savar_oms_catalog.product_template', function (require) {
    ...
    publicWidget.Widget.include({
        ...
        save_product_services: function()
        {
        ...
        init_product_service: function()
        {
            var self = this;
            var params = {
                            '_selector':$("input.product_service"),
                            '_route':'/selections/products/get_services',
                            '_fields':['id', 'name'],
            ...
            console.log(String('product_service: ') + String(product_service));            
        },
