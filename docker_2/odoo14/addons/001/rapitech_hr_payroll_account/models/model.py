...
class HrPayslip(models.Model):
                    ...
                    for line in slip.line_ids.filtered(lambda line: line.category_id):
                        ...
                        if debit_account_id: # If the rule has a debit account.
                            ...
                            if not debit_line:
                                ...
                                if line.slip_id.employee_id.payroll_analytic_ids:
                                    for analytic in line.slip_id.employee_id.payroll_analytic_ids:
    ...
    def _get_existing_lines(self, line_ids, line, account_id, debit, credit):
        existing_lines = (
            ...
            and line_id['analytic_account_id'] == (line_id['analytic_account_id'] or line.salary_rule_id.analytic_account_id.id or line.slip_id.contract_id.analytic_account_id.id)
...
class HrSalaryRule(models.Model):
    ...
    is_calculate_only = fields.Boolean('Desglosar por empleado') 