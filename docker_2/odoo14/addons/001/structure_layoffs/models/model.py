...
class employee(models.Model):
    ...
    def AverageWageAnnual(self,date_to,list_codes,contract_id):
        ...
        if struct_id:
            struct = struct_id.id
            date_start = date_to + relativedelta.relativedelta(months=-11)
    ...
    def MethodAverageAnnual(self,date_to,list_codes,contract_id):
       type_struct_id = contract_id.structure_type_id.id
       struct_id = self.env['hr.payroll.structure'].search([('type_id','=',type_struct_id)],limit=1)
       if struct_id:
           struct = struct_id.id
    ...
    def GetWorkedDaysAnnual(self,date_to,contract_id):
       type_struct_id = contract_id.structure_type_id.id
       struct_id = self.env['hr.payroll.structure'].search([('type_id','=',type_struct_id)],limit=1)
       days=0
       if struct_id:
